...
#ifdef TOF_DLL_EXPORTS
#	define TOF_API __declspec(dllexport)
#else
#	ifdef TOF_DLL_IMPORTS
#		define TOF_API __declspec(dllimport)
#	else
#		define TOF_API
#	endif
#endif
...
#define SDK_VER				"v2.2.0"	///< SDK Version
...
#define PRIVATE_ATTRIBUTES		class Impl; Impl* pImpl;
	...
	*/
	class TOF_API FrameMatrix : public FrameData{
	public:
	...
	* 	- A pixel data (16bit) is stored as little endian from v1.1.0.
	*/
	class TOF_API FrameDepth : public FrameMatrix{
	public:
	...
	*/
	class TOF_API FrameIr : public FrameMatrix{
	public:
		/**
		* @brief
		* 	Save to file
	...
	* 	Available from v1.1.0.
	*/
	class TOF_API Frame3d : public FrameData{
	private:
		PRIVATE_ATTRIBUTES
	...
	* 	Available from v1.3.0.
	*/
	class TOF_API FrameHumans : public FrameData{
	public:
